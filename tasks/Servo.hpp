...
#ifndef INTERFACES_SERVO_TASK_HPP
#define INTERFACES_SERVO_TASK_HPP
...
namespace interfaces {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','interfaces::Servo')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for Servo
         * \param name Name of the task. This name needs to be unique to make it identifiable via nameservices.
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        Servo(std::string const& name = "interfaces::Servo");
         ...
         * 
         */
        Servo(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of Servo
         */
	~Servo();
